...
;  - v8.32.0 新增：P0 安全改进四项（KDF 迭代回调至 600000、失败锁定 5 次 30 分钟持久化、
;    回收站 30 天自动过期、pinyin4j 合规替换），与安卓 A9.10.0 对齐
; ============================================================
[Setup]
...
OutputBaseFilename=密匣MimaVault安装程序_v8.32.0
Compression=lzma2
...
Source: "C:\Users\25323\AppData\Roaming\Tencent\Marvis\User\427DB28A6D593974C57919E2E330E344\workspace\conv_19fa4164394_39e9fc071869\temp\jpackage-out-v8320\密匣 MimaVault\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
