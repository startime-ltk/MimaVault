...
;  - v8.30.2 新增：密码生成器增强（排除易混淆字符 / 自定义字符集 / 口令短语）、
;    密码历史版本（改密前旧密码可回溯与恢复，仅保留最近 20 条）、CSV 导出默认脱敏 + 明文二次确认
; ============================================================
[Setup]
...
OutputBaseFilename=密匣MimaVault安装程序_v8.30.2
Compression=lzma2
...
Source: "C:\Users\25323\AppData\Roaming\Tencent\Marvis\User\427DB28A6D593974C57919E2E330E344\workspace\conv_19fa4164394_39e9fc071869\temp\jpackage-out-v8302\密匣 MimaVault\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
