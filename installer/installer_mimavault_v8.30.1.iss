...
;    用户可在主界面「数据目录」中把数据迁移到任意位置（v8.30.1 新增）
; ============================================================
[Setup]
...
OutputBaseFilename=密匣MimaVault安装程序_v8.30.1
Compression=lzma2
...
Source: "C:\Users\25323\AppData\Roaming\Tencent\Marvis\User\427DB28A6D593974C57919E2E330E344\workspace\conv_19fa4164394_39e9fc071869\temp\jpackage-out-v8301b\密匣 MimaVault\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
